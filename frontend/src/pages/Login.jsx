...
export const Login = () => {
  ...
  return (
    <div className="flex min-h-[65vh] items-center justify-center px-4 py-12 sm:px-6 lg:px-8 bg-slate-50/20">
      <div className="w-full max-w-md space-y-8 rounded-2xl border border-slate-100 bg-white p-8 shadow-[0_8px_30px_rgba(0,0,0,0.03)]">
        ...
        <form onSubmit={handleSubmit} className="mt-8 space-y-5">
          ...
          <div className="text-center pt-2 text-xs font-semibold text-slate-500">
            Don't have an Nest account?{' '}
            <Link to="/signup" className="text-brand-rose hover:underline font-bold">
              Sign up
            </Link>
          </div>
        </form>
